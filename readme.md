# Person Marking in South-Central Trans-Himalayan: Pangkhua

This PARALEX set contains person markers in Pangkhua, including inflected verbal forms and pronouns. It constitutes part of the PMST (Person Marking in South-Central Trans-Himalayan) database.
...
## Additional information specific to Pangkhua

* Tone: Pangkhua is described as having lexically contrastive high and low tone, though only a small number of elderly speakers make or discern this contrast (Akter 2024:57-58). According to the descriptive materials, tonal minimal pairs have collapsed into homophone pairs for the majority of speakers, especially those of younger generations. As such, Pangkhua can be understood as undergoing a process of tonoexodus. During the fieldwork trips in which the data contained in this dataset were collected, opportunity for working with speakers for whom tonal contrasts are still operative was limited, and the data which were collected could not be cross-checked. As such, tonal values are not marked here. 
* Optional marking of 3rd person: The pre-root 3rd person agent agent marker can be freely omitted for certain co-argument scenarios in the nonfuture-affirmative transitive indicative construction. 
* Label mapping: The labels used in this dataset for indicative constructions with different tense-polarity configurations (nonfuture-affirmative, nonfuture-negative, future-affirmative, future-negative) match those used in descriptive materials on Pangkhua person indexation (e.g. Akter 2024:266-267). 
